...
const PropertyDetails = () => {
  ...
  return (
    <div className="pt-28 min-h-screen bg-white">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="container mx-auto px-8 md:px-16 lg:px-24 py-3">
          <div className="flex items-center text-sm font-body">
            <Link to="/" className="text-[#ad8b3a] hover:underline">Home</Link>
            <span className="mx-2 text-gray-400">›</span>
            {property.cityId && (
              <>
                <Link to={`/city/${property.cityId}`} className="text-[#ad8b3a] hover:underline">{property.city || 'City'}</Link>
                <span className="mx-2 text-gray-400">›</span>
              </>
            )}
              ...
              {property.images && property.images.length > 2 && (
                ...
                >
                  ...
                  {property.images.length > 3 && (
                    ...
                    >
                      <button className="bg-white hover:bg-gray-100 text-[#13130F] font-medium py-2 px-4 rounded-full flex items-center transition-colors shadow-md">
      ...
      {/* Property Title Section with Ratings and Details - Updated for price range */}
      <div className="container mx-auto px-8 md:px-16 lg:px-24 py-8 border-b border-gray-200">
        <div className="flex flex-col md:flex-row justify-between items-start">
          <div className="text-left">
            <h1 className="text-3xl font-heading text-[#13130F] mb-2">
              {property.name}
            </h1>
            ...
            <div className="flex flex-wrap gap-4 mb-4 text-gray-700">
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1 text-[#ad8b3a]" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="flex items-center">
              ...
              <button 
                ...
                className="text-[#ad8b3a] hover:underline font-body"
              >
                {reviewCount} Reviews
              </button>
            </div>
          ...
          <div className="text-right mt-4 md:mt-0">
            <div className="text-2xl font-heading text-[#13130F]">
              ₹{(property.priceMin || 0).toLocaleString()} - ₹{(property.priceMax || 0).toLocaleString()}
            </div>
          ...
          <div className="lg:w-2/3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                {property.amenities && property.amenities.map((amenity, index) => (
                  <div key={index} className="flex items-center text-left">
                    <div className="mr-3 text-[#ad8b3a]">
            ...
            <div className="mb-16" ref={reviewsRef}>
              ...
              <div className="flex items-center mb-6">
                ...
                <span className="text-xl font-medium text-[#13130F] mr-2">
                  {averageRating}
                </span>
...
{review.profilePicture ? (
  <div className="relative group">
    ...
    />
    {/* Source icon overlay - with updated positioning */}
    ...
    {review.source && (
      <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-200 bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 text-xs font-medium text-white bg-[#13130F] rounded-md shadow-sm pointer-events-none whitespace-nowrap">
        Posted on {review.source.charAt(0).toUpperCase() + review.source.slice(1)}
        <svg className="absolute text-[#13130F] h-2 w-full left-0 top-full" x="0px" y="0px" viewBox="0 0 255 255">
  ...
  <div className="relative group">
    <div className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-medium ${getRandomColor(review.userName + index)}`}>
          ...
          <polygon className="fill-current" points="0,0 127.5,127.5 255,0" />
                        ...
                        <div className="flex-1 overflow-hidden text-left">
                          <div className="flex items-center mb-1">
                            <h4 className="font-medium font-subheading text-[#13130F] mr-2">{review.userName}</h4>
                            {review.isActive && (
                          ...
                          <p className="text-gray-700 break-words font-body">{review.description}</p>
                        </div>
                      </div>
                    </div>
                  ))}
                  ...
                  {visibleReviews < (property.reviews?.length || 0) && (
                    <div className="text-left pt-4">
                      <button 
                        ...
                        className="px-6 py-2 rounded-md flex items-center font-body"
                        style={{ backgroundColor: primaryBtnBg, color: primaryBtnText }}
                      >
                        Load More Reviews
                      </button>
                ...
                <div className="text-left py-6 text-gray-500 font-body">
...
{/* Photo gallery modal - Updated to maintain size with black background only for image area */}
{showAllPhotos && (
  <div className="fixed inset-0 bg-black/70 z-50 overflow-y-auto flex items-center justify-center">
    <div className="max-w-4xl w-full mx-auto my-6 bg-white rounded-lg shadow-2xl overflow-hidden relative">
      ...
      <div className="flex justify-between items-center p-6 border-b border-gray-200">
        <h3 className="text-xl font-medium font-subheading text-[#13130F]">All Photos</h3>
        <button 
      ...
      {/* Main image display area with black background */}
      <div className="bg-black flex items-center justify-center" style={{ height: "400px" }}>
        {property.images && property.images.length > 0 && (
          <img 
            src={property.images[currentModalImage].data} 
            alt={`${property.name} - Photo ${currentModalImage + 1}`}
      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24 py-8 text-center">
        <Link 
          ...
          className="inline-flex items-center text-[#ad8b3a] hover:text-[#ad8b3a]"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
