...
const CityManagement = ({ editingCity, onEditComplete }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    image: '',
    isActive: true,
    showOnHome: false, // Add the new field with default value
    thingsToDo: []
  });
  ...
  useEffect(() => {
    if (editingCity) {
      setFormData({
        ...
        showOnHome: editingCity.showOnHome !== undefined ? editingCity.showOnHome : false, // Handle the new field
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({
        ...
        image: '',
        isActive: true,
        showOnHome: false, // Reset showOnHome field
        thingsToDo: []
      });
      setCityImage(null);
      setCityImagePreview('');
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="mb-8 bg-white p-6 rounded-lg border border-gray-200">
        ...
        {/* Status checkboxes - Added showOnHome option */}
        <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex items-center">
            <input
              ...
              className="h-5 w-5 text-blue-600 rounded focus:ring-blue-500 border-gray-300"
            />
            <label htmlFor="showOnHome" className="ml-2 font-body text-left">Show on Home Page</label>
          </div>
        </div>
