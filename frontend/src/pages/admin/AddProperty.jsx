// // frontend/src/pages/admin/AddProperty.js
...
//         setSelectedAmenities(editingProperty.amenities.map(a => a.name));
//       }
...
//           {/* Amenities */}
//           <div>
//             <label className="block text-sm font-medium text-gray-700 mb-2 font-body text-left">
//               Amenities
//             </label>
...
//                     className="ml-2 text-sm text-gray-700 font-body"
//                   >
...
import React, { useState, useEffect, useCallback } from "react";
import axios from "axios";
import { Upload, PlusCircle, ChevronDown, ChevronUp, Star, Trash2, CheckCircle, XCircle, Edit } from 'lucide-react';
