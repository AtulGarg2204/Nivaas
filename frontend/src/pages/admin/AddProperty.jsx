...
//         subplace: editingProperty.subplace || "", // Added subplace field
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
                ...
                <form onSubmit={handleReviewSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
  <label className="block text-sm font-medium text-gray-700 mb-1 font-body text-left">
    Profile Picture (Optional) {/* Changed from Profile Picture * or Profile Picture {!editingReviewId && '*'} */}
  </label>
  <div className="flex">
    <input
      type="file"
