...
const AddProperty = ({ editingProperty = null, onEditComplete = () => {} }) => {
  ...
  useEffect(() => {
    if (editingProperty) {
      setFormData({
        ...
        subplace: editingProperty.subplace || "",
        ...
        priceMin: editingProperty.priceMin || 5000,
        priceMax: editingProperty.priceMax || 10000,
  ...
  const validatePriceRange = () => {
    ...
    if (min > max) {
      setMessage({ text: "Minimum price cannot be greater than maximum price", type: "error" });
      return false;
    }
  ...
  // Get the appropriate source icon
  ...
  // Get the appropriate source color
  ...
  return (
    <div>
      ...
      <div className="bg-white p-6 rounded-lg border border-gray-200 mb-6">
        <h3 className="text-xl font-medium font-subheading mb-6 border-b pb-2 text-left">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                type="text"
                name="subplace"
                value={formData.subplace}
                onChange={handleChange}
                placeholder="e.g., Downtown, West End, Near Beach"
                className="w-full px-4 py-2 border border-gray-300 rounded-md font-body focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded border border-gray-200">
              <h4 className="text-md font-medium font-subheading mb-3 text-left">Add New Amenity</h4>
            ...
            <div>
              <h4 className="text-md font-medium font-subheading mb-3 text-left">Current Amenities</h4>
      ...
      {editingId && (
        <div className="bg-white p-6 rounded-lg border border-gray-200 mb-6">
          ...
          >
            <h3 className="text-xl font-medium font-subheading">
              Property Reviews
            </h3>
          ...
          {expandReviews && (
            <div className="mt-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
                <h4 className="text-lg font-medium font-subheading mb-4 text-left">
              ...
              {property && (
                <div>
                  <h4 className="text-lg font-medium font-subheading mb-4 text-left border-b pb-2">
                  ...
                  {reviewsLoading ? (
                    ...
                    <div className="text-center py-6 text-gray-500 font-body">
                        ...
                        <div key={review._id} className={`p-4 rounded-lg border ${review.isActive ? 'bg-white border-gray-200' : 'bg-gray-50 border-gray-300'}`}>
                          <div className="flex justify-between">
                            <div className="flex items-start space-x-4">
                              ...
                              <div>
                                <div className="flex items-center">
                                  <h5 className="font-medium font-subheading text-gray-900">{review.userName}</h5>
