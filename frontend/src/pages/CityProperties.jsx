          ...
          <div className="container mx-auto py-8">
            ...
            {properties.length === 0 ? (
              ...
              <div className="bg-white rounded-lg p-8 shadow-md text-center">
                ...
                <Link to="/" className="inline-block bg-blue-500 text-white py-2 px-4 rounded-md font-body">
              ...
              <div className="flex flex-col lg:flex-row gap-8 relative">
                      ...
                      <div className="pt-5">
                        ...
                        <div className="flex gap-3 pt-4 border-t border-gray-200">
                          ...
                          <button 
                            ...
                            className="flex-1 py-3 bg-[#5f021f] text-white rounded-md font-body"
                          >
                            Apply
                          </button>
                        </div>
                ...
                {/* Filters - Left Side (Desktop Only) */}
                ...
                <div className={`${properties.length > 0 ? 'lg:w-3/4' : 'w-full'} lg:overflow-y-auto`}>
                          ...
                          <div className="p-0">
                            ...
                            <div className="p-4">
                              <div className="mb-2">
                                ...
                                <div className="text-gray-600 text-left text-sm font-body">{city.name}, {property.location || "Udaipur"}</div>
                              </div>
