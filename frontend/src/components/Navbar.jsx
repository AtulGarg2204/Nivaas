                        ...
                        {loading ? (
                          ...
                          cities.map(city => (
                            <div key={city._id}>
                              <Link 
                                to={`/city/${city._id}`}
                                className="block text-white text-sm font-body pl-2 py-1 border-l-2 border-cyan-300 text-left"
                                onClick={() => {
                                  setIsOpen(false);
                                  setShowCityDropdown(false);
                                }}
                                ...
                                <div className="mt-1 ml-4">
                                  {cityProperties[city._id].slice(0, 3).map(property => (
                                    <Link
                                      key={property._id}
                                      to={`/property/${property._id}`}
                                      className="block text-gray-300 text-xs font-body pl-2 py-1 border-l border-gray-600 text-left"
                                      onClick={() => {
                                        setIsOpen(false);
                                        setShowCityDropdown(false);
                                      }}
                                  ...
                                  {cityProperties[city._id].length > 3 && (
                                    <Link
                                      to={`/city/${city._id}`}
                                      className="block text-cyan-300 text-xs font-body pl-2 py-1 border-l border-gray-600 italic text-left"
                                      onClick={() => {
                                        setIsOpen(false);
                                        setShowCityDropdown(false);
                                      }}
