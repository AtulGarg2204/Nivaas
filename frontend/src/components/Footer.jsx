    ...
    <footer className="bg-[#0e3f44] text-white">
      <div className="container mx-auto px-8 md:px-12 lg:px-16 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <h3 className="text-lg font-bold mb-6 text-white font-heading">Top Destination</h3>
            <ul className="space-y-3">
              {[
                { name: "North Goa", url: "/destinations/north-goa" },
                { name: "Nainital", url: "/destinations/nainital" },
                { name: "Udaipur", url: "/destinations/udaipur" },
                { name: "Kasauli", url: "/destinations/kasauli" },
                { name: "Delhi NCR", url: "/destinations/delhi-ncr" },
                { name: "Jaipur", url: "/destinations/jaipur" },
                { name: "Mussoorie", url: "/destinations/mussoorie" },
                { name: "Shimla", url: "/destinations/shimla" }
              ].map((destination, index) => (
                <li key={index}>
                  <Link to={destination.url} className="text-gray-300 hover:text-white transition-colors font-body">
                    {destination.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { name: "Press release", url: "/press" },
                { name: "Partner with us", url: "/partner" },
                { name: "Corporate offsites", url: "/corporate" },
                { name: "Events", url: "/events" }
              ].map((link, index) => (
                <li key={index}>
                  <Link to={link.url} className="text-gray-300 hover:text-white transition-colors font-body">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          {/* Column 4: More */}
          <div>
            <h3 className="text-lg font-bold mb-6 text-white font-heading">More</h3>
            <ul className="space-y-3">
              {[
