// // frontend/src/components/PropertiesSection.js
...
//             {[1, 2, 3].map((item) => (
//               <div key={item} className="bg-white rounded-lg overflow-hidden shadow-lg border border-gray-100 h-96 animate-pulse">
...
//                     />
//                     <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 shadow-md font-semibold text-sm font-body z-20 transition-transform duration-300 group-hover:scale-110">
//                       ₹{property.price}/night
//                     </div>
//                   </div>
//                   <div className="p-6 flex-grow flex flex-col bg-gradient-to-b from-white to-gray-50/70">
//                     <div className="mb-1">
//                       <h3 className="text-xl font-bold font-heading text-gray-800 text-left group-hover:text-blue-600 transition-colors duration-300">
//                         {property.name}
//                       </h3>
//                     </div>
...
//                       <div className="relative overflow-hidden group-hover:before:opacity-100 before:opacity-0 before:absolute before:inset-x-0 before:h-px before:bottom-0 before:bg-gradient-to-r before:from-blue-500 before:via-purple-500 before:to-pink-500 before:transition-all before:duration-700">
//                         <button className="relative bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg px-5 py-2.5 text-sm font-medium font-body transition-all duration-300 shadow-sm hover:shadow-blue-500/20 group-hover:shadow-lg">
//                           View Details
...
// Updated PropertiesSection.js with the line next to View Details removed
import React, { useState, useEffect } from "react";
import axios from "axios";
import { Link } from "react-router-dom";
import { motion } from "framer-motion";
              ...
              >
                <div className="bg-white rounded-xl overflow-hidden shadow-[0_15px_35px_rgba(0,0,0,0.1)] border border-gray-100/80 transition-all duration-300 hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] h-full flex flex-col backdrop-blur-sm">
                  ...
                  <div className="p-6 flex-grow flex flex-col bg-gradient-to-b from-white to-gray-50/70">
                    ...
                    <div className="mt-auto text-left">
                      {/* Removed the decorative line div and simplified the button */}
                      <button className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg px-5 py-2.5 text-sm font-medium font-body transition-all duration-300 shadow-sm hover:shadow-blue-500/20 group-hover:shadow-lg">
                        View Details
                        <span className="absolute inset-x-0 bottom-0 h-0.5 bg-white/20"></span>
                      </button>
                    </div>
